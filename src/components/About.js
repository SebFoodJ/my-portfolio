            ...
            <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center">
                    ...
                    <p className="mb-8 leading-relaxed text-frenchgray">
                        &#128198; <b>Quand</b> : A partir d'Octobre 2023<br/>
                        &#9203; <b>Durée</b>  : 12 mois<br/>
                        &#127926; <b>Rythme</b>: 4 jours en entreprise / 1 jour en formation<br/>
                        &#127891; <b>Diplôme</b> : Concepteur Développeur d'Applications, RNCP niveau 6
                    </p>
