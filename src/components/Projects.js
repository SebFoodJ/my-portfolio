            ...
            <div className="container px-5 py-10 mx-auto text-center lg:px-40">
                <div className="flex flex-col w-full mb-5">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                        Voici quelques projets réalisés au cours de formation à <a href="https://adatechschool.fr/" target="_blank" className="text-lavender font-bold hidden lg:inline-block title-font">Ada Tech School</a>.
                    </p>
                </div>
