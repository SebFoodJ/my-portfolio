...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "static/js/" + ({}[chunkId]||chunkId) + "." + {"0":"6a526ff7"}[chunkId] + ".chunk.js";
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_62__CogIcon_js__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return __WEBPACK_IMPORTED_MODULE_216__UsersIcon_js__["a"]; });
...
var projects=[{title:"Mamie Caline",subtitle:"Retro-Gaming : Pico-8",description:"Création d'un jeu type dating simulator humoristique autour d'une grand-mère, baptisée Mamie Câline.",image:"./MamieCaline.gif",link:"https://andreabac.itch.io/mamie-caline-a-dating-simulator"},{title:"Web4All",subtitle:"Extension de navigateur Chrome",description:"Extension axé sur l'accessibilité pour les mal-voyant et daltoniens. Options d'écriture inclusive et suppression des gros mots.",image:"./Web4All.gif",link:"#"},{title:"Antikea",subtitle:"Plateforme de vente de meubles en PHP",description:"Création d'une plateforme de vente de meubles d'occasion en équipe de 8 sur une période de 2 semaines.",image:"./antikea.gif",link:"#"}];var testimonials=[{quote:"Sébastien Fougère incarne la fusion de la créativité et de la rigueur scientifique, modernisant notre société par ses réalisations remarquables.",image:"./testimonial-1.jpg",name:"Ada Lovelace",company:"Mathematician and Computer Pioneer"},{quote:"Sébastien Fougère's innovation knows no bounds, inspiring the tech industry worldwide.",image:"./testimonial-2.jpg",name:"Bill Gates",company:"Co-founder of Microsoft"},{quote:"Sébastien Fougère's pioneering spirit propelled AI and clean energy frontiers.",image:"./testimonial-3.jpg",name:"Elon Musk",company:"CEO of SpaceX and Tesla"},{quote:"Sébastien Fougère bridged worlds through tech, transforming global connections.",image:"./testimonial-4.jpg",name:"Sheryl Sandberg",company:"COO of Facebook"}];var skills=[{language:["HTML/CSS","JavaScript","ReactJs","Node","Git/GitHub","Tailwind","Bootstrap","Figma","Kotlin","SQL"]},{competences:["Adaptabilité","Ouverture d'esprit","Travail en équipe","Autonomie","Curiosté","Pensée critique"]}];
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_EmailJSResponseStatus__ = __webpack_require__(262);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__reportWebVitals__ = __webpack_require__(266);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__App_css__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Navbar__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Skills__ = __webpack_require__(255);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Projects__ = __webpack_require__(256);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Testimonials__ = __webpack_require__(257);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Contact__ = __webpack_require__(258);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_About__ = __webpack_require__(264);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Description__ = __webpack_require__(265);
function App(){return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement('main',{className:'text-gray-400 bg-repeat body-font bg-background-image'},__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_Navbar__["a" /* default */],null),__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__components_About__["a" /* default */],null),__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8__components_Description__["a" /* default */],null),__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_Projects__["a" /* default */],null),__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_Skills__["a" /* default */],null),__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__components_Testimonials__["a" /* default */],null),__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__components_Contact__["a" /* default */],null));}/* harmony default export */ __webpack_exports__["a"] = (App);
...
function Navbar(){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('header',{className:'bg-indigo opacity-70 md:sticky top-0 z-10 hover:opacity-100'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('p',{className:'font-medium text-lavender mb-4 md:mb-0'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h1',{className:'ml-3'},'SEBASTIEN FOUGERE')),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('nav',{className:'md:ml-auto flex font-medium flex-wrap items-center text-lavender justify-center'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('a',{href:'#description',className:'mr-5 hover:text-frenchgray'},'A propos'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('a',{href:'#projects',className:'mr-5 hover:text-frenchgray'},'Projets'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('a',{href:'#skills',className:'mr-5 hover:text-frenchgray'},'Techno & Skills'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('a',{href:'#testimonials',className:'mr-5 hover:text-frenchgray'},'T\xE9moignages'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('a',{href:'#contact',className:'mr-5 hover:text-frenchgray'},'Contact')),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('a',{href:'./myResume.pdf',target:'_blank',className:'inline-flex items-center bg-taupegray border-0 py-1 px-3 focus:outline-none hover:bg-indigo rounded text-lavender mt-4 md:mt-0'},'T\xE9l\xE9charger mon CV',__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__heroicons_react_solid__["a" /* ArrowRightIcon */],{className:'w-4 h-4 ml-1'}))));}
...
var languages=__WEBPACK_IMPORTED_MODULE_1__data_data__["b" /* skills */][0].language;var competences=__WEBPACK_IMPORTED_MODULE_1__data_data__["b" /* skills */][1].competences;function Skills(){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("section",{id:"skills"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"container px-5 py-10 mx-auto"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"text-center mb-5"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__heroicons_react_solid__["c" /* ChipIcon */],{className:"text-indigo w-10 inline-block mb-4"}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",{className:"sm:text-4xl text-3xl font-medium font-title text-lavender mb-4"},"Technologies"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"text-frenchgray leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto"},"Voici les technologies que j'ai eu l'occasion d'exp\xE9rimenter au cours de ma formation \xE0 Ada Tech School.")),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2"},languages.map(function(skill){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{key:skill,className:"p-2 sm:w-1/2 w-full"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"bg-indigo bg-opacity-70 rounded flex p-4 h-full items-center"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__heroicons_react_solid__["b" /* BadgeCheckIcon */],{className:" w-6 h-6 flex-shrink-0 mr-4"}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",{className:"title-font font-medium text-lavender text-center"},skill)));})),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"text-center mb-5 mt-20"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__heroicons_react_solid__["e" /* CogIcon */],{className:"text-indigo w-10 inline-block mb-4"}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",{className:"sm:text-4xl text-3xl font-medium font-title text-lavender mb-4"},"Soft Skills"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"text-frenchgray leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto"},"Voici mes comp\xE9tences.")),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2"},competences.map(function(skill){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{key:skill,className:"p-2 sm:w-1/2 w-full"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"bg-indigo bg-opacity-70 rounded flex p-4 h-full items-center"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__heroicons_react_solid__["b" /* BadgeCheckIcon */],{className:" w-6 h-6 flex-shrink-0 mr-4"}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",{className:"title-font font-medium text-lavender"},skill)));}))));}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__heroicons_react_solid__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_data__ = __webpack_require__(4);
// src/components/Projects.js
function Projects(){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("section",{id:"projects",className:"text-gray-400 body-font"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"container px-5 py-10 mx-auto text-center lg:px-40"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"flex flex-col w-full mb-5"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__heroicons_react_solid__["d" /* CodeIcon */],{className:"text-indigo mx-auto inline-block w-10 mb-4"}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",{className:"sm:text-4xl text-3xl font-medium font-title mb-4 text-white"},"Projets"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"lg:w-2/3 mx-auto leading-relaxed text-base"},"Voici quelques projets r\xE9alis\xE9s au cours de formation \xE0"," ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("a",{href:"https://adatechschool.fr/",target:"_blank",className:"text-lavender font-bold hidden lg:inline-block title-font"},"Ada Tech School"),".")),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"flex flex-wrap -m-4 rounded "},__WEBPACK_IMPORTED_MODULE_2__data_data__["a" /* projects */].map(function(project){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("a",{href:project.link,target:"_blank",key:project.image,className:"sm:w-1/2 w-100 p-4 rounded"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"flex relative rounded"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img",{alt:"gallery",className:"absolute inset-0 w-full h-full object-cover object-center rounded",src:project.image}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"px-8 py-10 relative z-10 w-full border-4 rounded bg-indigo opacity-0 hover:opacity-100"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h2",{className:"tracking-widest text-sm title-font font-medium text-frenchgray mb-1"},project.subtitle),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",{className:"title-font text-lg font-medium text-lavender mb-3"},project.title),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"leading-relaxed text-lavender"},project.description))));}))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("style",null,"\n                    @media (max-width: 640px) {\n                        .flex-wrap {\n                            flex-direction: column;\n                        }\n                    }\n                "));}
...
function Testimonials(){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("section",{id:"testimonials"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"container px-5 py-10 mx-auto text-center"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__heroicons_react_solid__["g" /* UsersIcon */],{className:"text-indigo w-10 inline-block mb-4"}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",{className:"sm:text-4xl text-3xl font-medium font-title text-lavender mb-12"},"Temoignages"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"flex flex-wrap m-4"},__WEBPACK_IMPORTED_MODULE_1__data_data__["c" /* testimonials */].map(function(testimonial){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"p-4 md:w-1/2 w-full"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"h-full bg-indigo bg-opacity-70 p-8 rounded shadow-sm"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"leading-relaxed mb-6 italic font-medium text-frenchgray"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__heroicons_react_solid__["f" /* TerminalIcon */],{className:"block w-8 text-frenchgray mb-4"}),testimonial.quote),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"inline-flex items-center"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img",{alt:"testimonial",src:testimonial.image,className:"w-20 h-20 rounded-full flex-shrink-0 object-cover object-center"}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",{className:"flex-grow flex flex-col pl-4"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",{className:"title-font font-medium text-white text-left"},testimonial.name),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",{className:"text-indigo-100 text-sm uppercase"},testimonial.company)))));}))));}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__emailjs_browser__ = __webpack_require__(259);
// src/components/Contact.js
function Contact(){var form=Object(__WEBPACK_IMPORTED_MODULE_0_react__["useRef"])();var sendEmail=function sendEmail(e){e.preventDefault();//s'assurer que le nom et le message soit remplis, et soit le numero soit l'email soit remplis, si non, ne pas envoyer le mail
if(form.current.user_name.value===''||form.current.message.value===''||form.current.user_email.value===''&&form.current.user_phoneNum.value===''){alert('Veuillez remplir les champs obligatoires');return false;}//si le numero est remplis, s'assurer qu'il soit valide
if(form.current.user_phoneNum.value!==''){if(form.current.user_phoneNum.validity.patternMismatch){alert('Veuillez entrer un numéro de téléphone valide');return false;}}//si l'email est remplis, s'assurer qu'il soit valide
if(form.current.user_email.value!==''){if(form.current.user_email.validity.patternMismatch){alert('Veuillez entrer une adresse email valide');return false;}}//si tout est ok, envoyer le mail
__WEBPACK_IMPORTED_MODULE_1__emailjs_browser__["a" /* default */].sendForm('contact_service','contact_form',form.current,'Uf7jv8sCKsV8qdaJO').then(function(result){//faire apparaitre un message de confirmation
alert("Votre message a bien été envoyé !");},function(error){console.log(error.text);});form.current.reset();};return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('section',{id:'contact',className:'relative'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'lg:w-2/3 md:w-1/2 bg-darkgray rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('iframe',{width:'100%',height:'100%',title:'map',className:'absolute inset-0',style:{filter:"opacity(0.7)"},src:'https://www.google.com/maps/embed/v1/place?q=4+Rue+du+Puits+d\'Argent,+Nantes,+France&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8'}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'bg-indigo relative flex flex-wrap py-6 rounded shadow-md'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'lg:w-3/5 px-6'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h2',{className:'title-font font-semibold text-lavender tracking-widest text-xs'},'ADRESSE'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('p',{className:'mt-1'},'4 rue du Puits d\'Argent ',__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('br',null),'44000 Nantes')),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'lg:w-1/2 px-6 mt-4 lg:mt-0'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h2',{className:'title-font font-semibold text-lavender tracking-widest text-xs'},'EMAIL'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('p',{className:'text-frenchgray leading-relaxed',href:'#'},'sebastien.fougere@gmail.com'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h2',{className:'title-font font-semibold text-lavender tracking-widest text-xs mt-4'},'T\xC9L\xC9PHONE'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('p',{className:'leading-relaxed'},'07 67 79 59 67')))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('form',{ref:form,name:'contact',onSubmit:sendEmail,className:'lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h2',{className:'text-white sm:text-4xl text-3xl mb-1 font-medium font-title'},'Contactez-moi'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('p',{className:'leading-relaxed mb-5'},'N\'h\xE9sitez pas \xE0 me contacter pour toute question.'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'relative mb-4'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('label',{htmlFor:'name',className:'leading-7 text-sm text-gray-400'},'Nom'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input',{type:'text',required:'required',id:'name',name:'user_name',className:'w-full bg-silver rounded border border-taupegray focus:border-indigo focus:ring-2 focus:ring-indigo text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out'})),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'relative mb-4'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('label',{htmlFor:'email',className:'leading-7 text-sm text-gray-400'},'Email'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input',{type:'email',required:'required',id:'email',name:'user_email',className:'w-full bg-silver rounded border border-taupegray focus:border-indigo focus:ring-2 focus:ring-indigo text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out'})),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'relative mb-4'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('label',{htmlFor:'phoneNum',className:'leading-7 text-sm text-gray-400'},'Num\xE9ro de t\xE9l\xE9phone'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input',{type:'tel',pattern:'[0-9]{10}',id:'phoneNum',name:'user_phoneNum',className:'w-full bg-silver rounded border border-taupegray focus:border-indigo focus:ring-2 focus:ring-indigo text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out'})),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'relative mb-4'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('label',{htmlFor:'message',className:'leading-7 text-sm text-gray-400'},'Message'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('textarea',{id:'message',required:'required',name:'message',className:'w-full bg-silver rounded border border-taupegray focus:border-indigo focus:ring-2 focus:ring-indigo h-32 text-base outline-none text-gray-100 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out'})),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('button',{type:'submit',value:'Send',className:'text-lavender font-medium bg-indigo border-0 py-2 px-6 focus:outline-none hover:bg-taupegray rounded text-lg'},'Envoyer'))));}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__methods_init_init__ = __webpack_require__(260);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__methods_send_send__ = __webpack_require__(261);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__methods_sendForm_sendForm__ = __webpack_require__(263);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
function About(){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("section",{id:"about"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"container mx-auto flex px-10 py-20 md:flex-row flex-col items-center"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",{className:"title-font sm:text-4xl text-3xl mb-4 font-medium text-lavender"},"Salut, moi c'est ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b",{className:"text-white dropShadow-title font-title tracking-widest"},"Sebastien"),".",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br",null),"Je suis \xE9tudiant en d\xE9veloppement web."),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h2",{className:"title-font sm:text-4xl text-3xl mb-4 font-medium"},"A la recherche d'une alternance !"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"mb-8 leading-relaxed text-frenchgray"},"\uD83D\uDCC6 ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b",null,"Quand")," : A partir d'Octobre 2023",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br",null),"\u23F3 ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b",null,"Dur\xE9e"),"  : 12 mois",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br",null),"\uD83C\uDFB6 ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b",null,"Rythme"),": 4 jours en entreprise / 1 jour en formation",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br",null),"\uD83C\uDF93 ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b",null,"Dipl\xF4me")," : Concepteur D\xE9veloppeur d'Applications, RNCP niveau 6"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"flex justify-center"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("a",{href:"#contact",className:"inline-flex text-lavender bg-indigo border-0 py-2 px-6 focus:outline-none hover:bg-frenchgray hover:text-indigo rounded text-lg"},"Travaillons ensemble !"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("a",{href:"#projects",className:"ml-4 inline-flex text-lavender bg-taupegray border-0 py-2 px-6 focus:outline-none hover:bg-silver hover:text-lavender rounded text-lg"},"Voir mes projets"))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"lg:max-w-lg lg:w-full md:w-1/2 w-5/6 animate-pulse"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img",{className:"object-cover object-center shadow-2xl rounded-full max-w-full h-auto align-middle border-none",alt:"profil",src:"./picofme2.png"}))));}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
function Description(){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("section",{id:"description",className:"px-30 my-50"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"flex flex-wrap items-center px-10"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"w-full md:w-1/3 px-20"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img",{className:"w-full",alt:"a propos",src:"./apropos.svg"})),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"md:w-2/3 px-10 place-self-center"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",{className:"text-3xl text-white font-bold mb-4"},"A propos de moi..."),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"mb-4 text-lavender"},"\"\xC9tudiant \xE0"," ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("a",{href:"https://adatechschool.fr/",target:"_blank",className:"text-indigo font-title"},"Ada Tech School"),", une \xE9cole \xE0 la p\xE9dagogie alternative qui valorise la pratique et les projets collectifs, j'ai eu l'opportunit\xE9 de travailler sur"," ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b",{className:"text-white"},"6 projets collectifs en l'espace de 8 mois"),". Ces projets, rythm\xE9s par des rituels issus de la"," ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b",{className:"text-white"},"m\xE9thodologie Agile"),", m'ont permis de d\xE9velopper des comp\xE9tences essentielles pour le monde professionnel."),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"mb-4 text-lavender"},"Au fil de mes exp\xE9riences professionnelles, j'ai explor\xE9 diff\xE9rentes voies, notamment en"," ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b",{className:"text-white"},"\xC9v\xE9nementiel")," au sein d'une agence de communication, puis en tant que ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b",{className:"text-white"},"Chef de Cuisine")," dans des restaurants gastronomiques et bistronomiques."),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"mb-4 text-lavender"},"Ces r\xE9orientations sont le r\xE9sultat de mon"," ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b",{className:"text-white"},"d\xE9sir constant d'acqu\xE9rir de nouvelles comp\xE9tences")," et de m'adapter \xE0 de nouveaux environnements. La"," ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b",{className:"text-white"},"curiosit\xE9")," est mon moteur, et elle m'incite \xE0 rechercher en permanence de nouvelles connaissances.\""))));}
...
"use strict";
var reportWebVitals=function reportWebVitals(onPerfEntry){if(onPerfEntry&&onPerfEntry instanceof Function){__webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 267)).then(function(_ref){var getCLS=_ref.getCLS,getFID=_ref.getFID,getFCP=_ref.getFCP,getLCP=_ref.getLCP,getTTFB=_ref.getTTFB;getCLS(onPerfEntry);getFID(onPerfEntry);getFCP(onPerfEntry);getLCP(onPerfEntry);getTTFB(onPerfEntry);});}};/* harmony default export */ __webpack_exports__["a"] = (reportWebVitals);

/***/ })
/******/ ]);
//# sourceMappingURL=main.78370faa.js.map